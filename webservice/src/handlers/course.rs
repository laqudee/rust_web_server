...
mod tests {
    ...
    async fn get_all_courses_success() {
        ...
        let teacher_id: web::Path<(i32,)> = web::Path::from((235,));
    ...
    async fn get_course_detail_success() {
        ...
        let params: web::Path<(i32, i32)> = web::Path::from((235, 2));
    ...
    async fn delete_course_success() {
        ...
        let params: web::Path<(i32, i32)> = web::Path::from((937, 3));
    ...
    async fn delete_course_failure() {
        ...
        let params: web::Path<(i32, i32)> = web::Path::from((937, 101));
